...
@PluginDescriptor(
      name = "BD One Click Pickpocket",
      description = "BD QOL for pickpocketing",
      tags = {"BD","pickpocket","skilling","thieving"},
...
public class OneClickThievingPlugin extends Plugin
{
   ...
   private int WATCHDOG_TIMEOUT = 50;
   private int watchdog = WATCHDOG_TIMEOUT;
   ...
   public void onMenuOptionClicked(MenuOptionClicked event)
   {
      ...
      if(config.clickOverride() && event.getMenuOption().equals("BD One Click Pickpocket"))
      {
